...
if __name__ == "__main__":
    ...
    sample_block = {
        "header": {
            "index": 1,
            "prev_hash": "0"*64,
            "merkle_root": hashlib.sha256("a1b2c3d4e5").hexdigest(),
    ...
    # 初始化
    redis_db = RedisModule(db_name="yjk_chain_test", port=6379)
    ...
    # 哈希表操作示例
    block_header = {
        "prev_hash": hashlib.sha256("0000abc...").hexdigest(),
        "merkle_root": hashlib.sha256("123def...").hexdigest(),
        "nonce": "12345"
    }
    ...
    # 添加UTXO示例
    utxo_data = {
        "txid": hashlib.sha256("a1b2c3d4e5f67890").hexdigest(),
        "vout_index": 0,
        "amount": 3.5,
        "address": "1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa",
        "script_pubkey": hashlib.sha256("76a91462e907b15cbf27d5425399ebf6f0fb50ebb88f1888ac").hexdigest()
    }
